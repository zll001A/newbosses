...
<!-- Custom Theme files -->
<link href="statics/about/css/bootstrap.css" type="text/css" rel="stylesheet" media="all">
<link href="statics/about/css/style.css" type="text/css" rel="stylesheet" media="all">
<link href="statics/about/css/font-awesome.css" rel="stylesheet">  <!-- font-awesome icons --> 
<!-- //Custom Theme files -->
<!-- js -->
		...
		<div class="container">  
			...
			<div class="about-w3ls-row"> 
				<div class="col-md-5 about-left">
					<img src="statics/about/images/about.jpg" class="img-responsive" alt=""/>
				</div>
							...
							<div id="myTabContent" class="tab-content">
								<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
									<div class="tabcontent-grids">
										<p>我们是一群来自上海尚学堂的程序猿，第一次做项目，还请多担待！</p>
										<p>联系我们请至上海市松江区荣乐东路2369弄45号绿地伯顿大厦2层</p>
										<div id="container">
											<script>
											 var map = new AMap.Map('container', {
											        zoom:16,//级别
											        center: [121.246202,31.016408],//中心点坐标
											        viewMode:'3D'//使用3D视图
											    });
											 
											 var marker = new AMap.Marker({
											        position:[121.246202,31.016408]//位置
											    })
		...
		<div class="container">
			<div class="work-agileinfo">
				...
				<div class="w3btns-agile">
					<a href="index.jsp">Get In Touch</a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="team agileits-w3layouts" >
		<div class="container"> 
			...
			<div class="team-info wthree" >
				<div class="col-md-6 team-w3lsgrids" id="div1">
					<div class="team-left">
						<img class="img-responsive" src="statics/about/images/1.jpg" alt="">
					</div>
			...
			<div class="team-info wthree">
				<div class="col-md-6 team-w3lsgrids">
					<div class="team-left">
						<img class="img-responsive" src="statics/about/images/13.jpg" alt="">
					</div>
					<div class="team-right">
						<h4>wr</h4>
						<p>登录注册</p>
				...
				<div class="col-md-6 team-w3lsgrids">
					<div class="team-left">
						<img class="img-responsive" src="statics/about/images/2.jpg" alt="">
					</div>
					<div class="team-right">
						<h4>xc </h4>
						<p>学校模块</p>
			...
			<div class="team-info team-row2">
				<div class="col-md-6 team-w3lsgrids">
					<div class="team-left">
						<img class="img-responsive" src="statics/about/images/3.jpg" alt="">
					</div>
					<div class="team-right">
						<h4>lsy </h4>
						<p>个人中心</p>
				...
				<div class="col-md-6 team-w3lsgrids">
					<div class="team-left">
						<img class="img-responsive" src="statics/about/images/14.jpg" alt="">
					</div>
					<div class="team-right">
						<h4>fjj</h4>
						<p>数据分析、关于我们</p>
